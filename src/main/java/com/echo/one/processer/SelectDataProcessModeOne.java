...
@Component(value = "process.selectData.1")
public class SelectDataProcessModeOne extends ProcessMode {

    private static final Logger logger = LoggerFactory.getLogger(SelectDataProcessModeOne.class);
    ...
    protected void handler(TransferContext transferContext) {
        ...
        logger.info("traceId: {}, 开始执行mode为1的查询过程", traceId);
