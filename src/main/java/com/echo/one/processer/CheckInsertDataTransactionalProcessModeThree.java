...
@Component(value = "process.checkInsertData.3")
public class CheckInsertDataTransactionalProcessModeThree extends ProcessMode {

    private static final Logger logger = LoggerFactory.getLogger(CheckInsertDataTransactionalProcessModeThree.class);
    ...
    protected void handler(TransferContext transferContext) {
        ...
        logger.info("traceId: {}, 开始执行mode为3的检查插入代码", traceId);
